...
import WebCubatorLogo from "@/public/logo.png";
...
export default function Navbar() {
  ...
  return (
    <header className="sticky inset-x-0 top-0 z-50 bg-white bg-opacity-30 backdrop-blur-sm border-b border-gray-600 border-opacity-10">
      <nav
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Disclosure.Panel className="mt-2 space-y-2">
                        {[...domains, ...callsToAction].map((item) => (
                          <Disclosure.Button
                            key={item.name}
                            as="a"
                            href={item.href}
